      ...
      <main className="flex-grow flex flex-col">
        ...
        <header className="px-10 py-16 text-center">
          ...
          <p className="text-xl text-agro-dark/60 max-w-3xl mx-auto leading-relaxed">
            Recibe consejos sobre agricultura basados en nuestras tierras salvadoreñas
          </p>
        </header>

        {/* Main Grid Content */}
        <div className="flex-1 grid grid-cols-[1.2fr_1fr] gap-10 px-10 py-6 overflow-hidden">
          <Chatbot />
          <AboutUs />
        </div>
      </main>
