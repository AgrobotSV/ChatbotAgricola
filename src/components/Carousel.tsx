...
const images = [
  {
    url: 'https://lh3.googleusercontent.com/d/1GuVoRlZS9WCHqngfSCwA3bg4XJeiaLaQ',
    title: 'Valles de Zapotitán',
    description: 'Corazón agrícola de El Salvador'
  },
  {
    url: 'https://lh3.googleusercontent.com/d/1PmB_NELAOcwXVNiZdDvEPkGukXKtNfFi',
    title: 'Cafetales de Apaneca',
    description: 'Nuestro grano de oro en las alturas'
  },
  {
    url: 'https://lh3.googleusercontent.com/d/1AasNX6dp3Iglxynk5DrP1jL7J9S-WUa6',
